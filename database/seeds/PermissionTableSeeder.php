...
class PermissionTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $permission = [
         ...
         //    ],
            [//laporan-pemesanans
                 'name' => 'laporan_pemesanan-list',
                 'display_name' => 'Display Laporan_pemesanan Listing',
                 'description' => 'See only Listing Of Laporan_pemesanan'
            ],
            [
                 'name' => 'laporan_pemesanan-harian',
                 'display_name' => 'Laporan_pemesanan Harian',
                 'description' => 'New Laporan_pemesanan Harian'
            ],
            [
                 'name' => 'laporan_pemesanan-mingguan',
                 'display_name' => 'Laporan_pemesanan Mingguan',
                 'description' => 'Laporan_pemesanan Mingguan'
            ],
            [
                 'name' => 'laporan_pemesanan-bulanan',
                 'display_name' => 'Laporan_pemesanan Bulanan',
                 'description' => 'Laporan_pemesanan Bulanan'
            ],
            [
                 'name' => 'laporan_pemesanan-tahunan',
                 'display_name' => 'Laporan_pemesanan Tahunan',
                 'description' => 'Laporan_pemesanan Tahunan'
            ]
        ];
